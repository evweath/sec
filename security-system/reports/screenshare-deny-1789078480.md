...
# 2026-09-10 17:14:40  model=/tmp/evw-ls-model-qyr1d9dd.json  apply=True
# config=/var/db/evw-security-system/security-system.json  identifiers=13 (config=12 ensure=1)
# ADD=0 rules  SKIP=13 identifiers (already covered)
